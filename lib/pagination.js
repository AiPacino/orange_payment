...
class Pagination {
  ...
  constructor(opts = {}){
    ...
    this.showNum = opts.hasOwnProperty('show_num') ? opts.show_num : 5

    if (this.showNum <= 3 && this.showNum != 0){
      this.showNum = 3
    }

    this.prev = opts.prev ? opts.prev : '&lt;'
    this.next = opts.next ? opts.next : '&gt;'
  }
  ...
  create(url , count , page = 1 , size = 10 , query = {}){
    ...
    if (this.showNum == 0){
      pagination += `<li class="page-item page-count"><a class="page-link " href="javascript:;">第${currentNum}页/共${total}页</a><li>`
    }else {
  ...
  _createPrev(url , total , currentNum , query = {}){
    let str = ''
    if (1 == currentNum){
      str += '<li class="page-item disabled page-prev"><a class="page-link" href="javascript:;" >' + this.prev + '</a></li>'
    }else {
      let num = parseInt(currentNum) - 1
      let href = this._createHref(url , num , query)
      str += '<li class="page-item page-prev"><a class="page-link" href="' + href + '" >' + this.prev + '</a></li>'
    }
  ...
  _createNext(url , total , currentNum , query = {}){
    let str = ''
    if (total == currentNum){
      str += '<li class="page-item page-next disabled"><a class="page-link" href="javascript:;" >' + this.next + '</a></li>'
    }else {
      let num = parseInt(currentNum) + 1
      let href = this._createHref(url , num , query)
      str += '<li class="page-item page-next"><a class="page-link" href="' + href + '" >' + this.next + '</a></li>'
    }
